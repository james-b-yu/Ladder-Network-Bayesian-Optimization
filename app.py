...
class AutoEncoder:
    ...
    def init_model(self):
        self.model: nn.Module = self.cfg["model"](
    ...
    def go(self):
        ...
        metricss = t.zeros((self.cfg["epochs"], num_examples, 3), dtype=t.float64, device=self.device)
